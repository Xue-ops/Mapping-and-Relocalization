...
def _load_small_point_lio_params(context):
    params_file = LaunchConfiguration("relocalization_params_file").perform(context)
    ...
    return LaunchDescription([
        ...
        *[
            DeclareLaunchArgument(
                ...
                description=f"Override {name}; default is loaded from relocalization_params_file.",
            )
